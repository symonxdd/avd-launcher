...
import { HiDeviceMobile, HiDocumentText, HiCog, HiSun, HiMoon, HiAdjustments, HiViewGrid, HiGift, HiPencil, HiTrash, HiPlay, HiStop, HiExclamation, HiDotsHorizontal, HiArrowUp, HiArrowDown, HiInformationCircle, HiCheck, HiX, HiSparkles, HiRefresh, HiFolderOpen, HiDatabase, HiMenu, HiChip, HiShoppingBag, HiExternalLink, FaGithub, FaSnowflake, FaWind } from "oh-vue-icons/icons";
